...
const hooks_cmake = hooks + ".cmake"
const HOOKS_CMAKE_POSTCMAKE = hooks_cmake + hooks_postcmake_suffix
const HOOKS_CMAKE_PRECMAKE = hooks_cmake + hooks_precmake_suffix
...
const hooks_postcmake_suffix = ".postcmake"
...
const hooks_precmake_suffix = ".precmake"
